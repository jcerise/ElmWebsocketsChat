...
var _user$project$Main$displayChatMessages = function (chatMessages) {
	return A2(
		...
		switch (_p0.ctor) {
			case 'PostChatMessage':
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$websocket$WebSocket$send, 'ws://0.0.0.0:3000/chat', message)
						]));
			case 'UpdateUserMessage':
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
				var messages = A2(_elm_lang$core$List_ops['::'], _p0._0, model.chatMessages);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {chatMessages: a, userMessage: b};
	});
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, 'ws://0.0.0.0:3000/chat', _user$project$Main$NewChatMessage);
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Main$displayChatMessages(model.chatMessages)
			]));
};
